    ...
    <el-table border stripe :data="tableData" @sort-change="sort" :default-sort="defaultSort">
      ...
      <el-table-column label="操作" width="150" fixed="right">
        <template #default="scope">
          <ButtonGroupTable>
            <el-button @click="showDialogForm({ data: scope.row, readonly: true })" type="primary" size="small"
              >查看</el-button
            >
...
import ButtonQuery from '~/components/button/button-query.vue';
import ButtonGroupTable from '~/components/button/button-group-table.vue';
...
const queryTableData = () => {
  ...
  apis.getAdminUserPage(selectModel).then((data) => {
